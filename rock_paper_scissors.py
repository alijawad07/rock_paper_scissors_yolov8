...
while True:
    ...
    if left_player and right_player:
        ...
        if (left_object == "Rock" and right_object == "Scissors") or (left_object == "Paper" and right_object == "Rock") or (left_object == "Scissors" and right_object == "Paper"):
            ...
            if (right_color == (0, 0, 255) and left_color == (0, 255, 0)) and (last_detection == ((255, 255, 255),(255, 255, 255))):
                left_wins += 1
                right_losses += 1
            ...
            if (left_color == (0, 0, 255) and right_color == (0, 255, 0)) and (last_detection == ((255, 255, 255),(255, 255, 255))):
                right_wins += 1
                left_losses += 1
                last_detection = (left_color, right_color)
        ...
        cv2.putText(frame, classes[int(class_idx)], (int(xmax), int(ymax) - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, left_color, 2)
        xmin, ymin, xmax, ymax, _, class_idx = right_player
        cv2.rectangle(frame, (int(xmin), int(ymin)), (int(xmax), int(ymax)), right_color, 2)
        cv2.putText(frame, classes[int(class_idx)], (int(xmax), int(ymax) - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, right_color, 2)
    ...
    cv2.putText(frame, "Model: Yolov8x", (10, frame_height - 20), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 128, 128))
